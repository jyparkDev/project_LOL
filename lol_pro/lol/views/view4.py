...
#     blue1 = request.GET['blue1']
    
    
#     print(blue1)
    path = os.path.abspath(os.path.dirname(__file__))
    rf = pickle.load(open(path + '/model/randomforest_indi.sav', 'rb'))
    model = load_model(path + '/model/sequential_indi.hdf5')
    ...
    # pred = model.predict([zboth_team_mean_list])
